...
let famous_person = "Adolf Hilter ";
let message = "if you want a shine like a sun you have to burn like it";
console.log(`${famous_person} once said ,"${message}"`);
//6  Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and end of the name. Make sure you use each character combination, "\t" and "\n", at least once. Print the name once, so the whitespace around the name is displayed. Then print the name after striping the white spaces.
console.log("hello\tworld"); // \t: extra space
console.log("hello\nworld"); // \n: new line
let fname = "ibrahim\tsaleem";
let fname1 = "ibrahim\nsaleem";
console.log(fname);
console.log(fname1);
...
let names = ["farooq", "ruquaiya", "chotoo"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
//12 Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
let message1 = "is the founder of using mob";
...
let Guest = ["Saadia", "Saleem", "Ibrahim"];
...
let empolyee = ["Saadia", "Ibrahim", "Farooq", "Saleem", "Ruquiya"];
...
let new_users = ["Jane", "Mike", "Sarah", "Bob", "Chris"];
...
function city_country(city, countries) {
...
let magician_names = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller"];
...
let magician_names1 = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller"];
...
let magician_names4 = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller"];
let magician_names_copy = magician_names4.slice();
let great_magicians = make_great1(magician_names_copy);
